_Weapon (rapier), legendary (requires attunement by an elf or half-elf of neutral good alignment)_

A _Dream Warden Rapier_ serves only one master at a time. The attunement process requires a special ritual in the throne room of an elven regent or in a temple dedicated to the elven gods.

A _Dream Warden Rapier_ has one rune on its blade for each master it has served (typically 1d6 + 1). The first rune always grants a +1 bonus to attack and damage rolls made with this magic weapon. Each rune beyond the first grants the _moonblade_ an additional property. The DM chooses each property or determines it randomly on the Dream Warden Rapier Properties table.

**Moonblade Properties**
- Plus 1
- Resistance to Necrotic
- Radiant Damage
- Fog (spell) only concentration when not on me
